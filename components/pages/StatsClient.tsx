                ...
                {statsData.tasksByCategory.map((category, index) => (
                  <div key={index} className='p-4 bg-gray-50 rounded-lg'>
                    ...
                    <div className='flex justify-between text-xs text-gray-500 mt-2'>
                      <span>{category.completed} completadas</span>
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div key={skill.id} className='p-6 bg-gray-50 rounded-lg'>
                      ...
                      <div>
                        <h3 className='font-semibold text-gray-800 capitalize'>
                          {skill.skillType === 'physical'
                            ...
                            ? 'Sabiduría'
                            : skill.skillType === 'mental'
                            ? 'Mental'
                            : skill.skillType === 'social'
                            ? 'Social'
                            : skill.skillType === 'creativity'
                            ? 'Creatividad'
                            : 'Disciplina'}
                        </h3>
                  ...
                  <div className='mb-2'>
                    <div className='flex justify-between text-sm text-gray-600 mb-1'>
                      ...
                      <span>
                        {skill.currentXP} / {skill.level * 200}
                      </span>
                    </div>
                    <ProgressBar
              ...
              <div className='space-y-3'>
                {statsData.tasksLast30Days.slice(0, 10).map((task, index) => (
                  ...
                  >
                    ...
                    <div className='text-sm font-medium text-blue-600'>✅ Completada</div>
                  </div>
                ))}
